...
void cover_page()
{
    ...
    printf("\n");
    printf("\n\t\t  1. Irfan Ahmad Alvi(212-15-4148)                     Dr. Sheak Rashed Haider Noori  ");
    printf("\n\t\t  2. Fahmida Ahmed Tonni(212-15-4099)                 Associate Professor & Associate Head");
    printf("\n\t\t  3. Pranto Saha(212-15-4157)                          Department of CSE               ");
    printf("\n\t\t  4. Hasibul Hossain Shanto(212-15-4082)               Daffodil International University ");
    printf("\n\t\t                                                                                         ");
    printf("\n\t\t                                                                Krishno Dey");
    printf("\n\t\t                                                            Teaching Assistant ");
    printf("\n\t\t                                                            Department of CSE ");
